...
![Notebook](./notebook.jpeg "My journal got ruined by a monsoon in Cambodia, more on that later...")
...
![European streets in Ha Long](./ha_long_random_french_quarter.jpeg "An apocalyptic Austria, or Vietnam?")
...
![Chinese Uncle](./ha_long_chinese_uncle.jpeg "He wanted a photo, so I got one too")
...
![Tour boat, Ha Long Bay](./ha_long_boat.jpeg "Your typical tour boat")
...
![Hanoi Bridge](./hanoi_bridge_bikes_2.jpeg)
...
![Banh Mi 25](./hanoi_banhmi25.jpeg "The most popular Banh Mi shop in Hanoi, Banh Mi 25")
...
![Hanoi beer in Train Street](./hanoi_train_street_beer.jpeg "It doesn't _taste_ better, but it's cheaper, so it's better")
...
![Officer of Train Street](./hanoi_train_street_officer.jpeg "You can see the officer, just before he took some photos")

![As the train passes](./hanoi_train_street_train_approaching_blurry.jpeg "Not a phone in sight, just living in the moment")
...
![Grab Bike](./hanoi_grab_bike_driver.jpeg "Grab Bikes are the unsung heroes of south east asia")

As an aside, [Grab](https://www.grab.com/sg/) is another "must-have" app for south east asia.
...
![B52 Lake](./hanoi_b52_lake.jpeg "The B52 bomber that was never removed")
...
![Ho Chi Minh Mausoleum](./hanoi_hochiminh_mausoleum_2.jpeg "Supposedly, Ho Chi Minh is still inside")
...
![Cycling Mafia](./hanoi_cycling_mafia_2.jpeg "Top tip: agree on a price before you get on one of these")
...
![Train through Hanoi](./vietnam_train_hanoi_to_hoian_bike.jpeg "Waving at the locals as we leave Hanoi")
...
![Hoi An](./hoi_an_lanterns_2.jpeg "The trademark lanterns of Hoi An, as seen from a rooftop cafe")
...
![Suiting up](./hoi_an_suit_fitting.jpeg "Suit measurements, featuring my beige linen and Harry in the background")
...
![Party in Hoi An](./hoi_an_party.jpeg "Travelling is about meeting people after all")

## Train from Hoi An to Saigon

![Train from Hoi An to Saigon](./vietnam_train_hoian_to_saigon.jpeg "The views from the train. Somewhere between Hoi An and Saigon")
...
![War Remnants Museum](./saigon_war_museum.jpeg "No photos from the inside, it gets quite graphic")
...
![Cu Chi Tunnels](./cu_chi_tunnel.JPG "Snug fit in the Cu Chi Tunnels")
...
![American with a gun](./cu_chi_gun.JPG "It didn't feel very _ethical_ to fire American guns near a war site, but Americans will be Americans")
...
![Drinks in Bui Van](./saigon_rooftop_bar.jpeg "Drinks with Alfonso and Harry")
